...
# from adafruit_st7789 import ST7789 as DISPLAY; ROTATION=180; WIDTH=240; HEIGHT=320  #Uncomment this if using the original 2-inch waveshare display
from adafruit_ili9341 import ILI9341 as DISPLAY; ROTATION=270; WIDTH=240; HEIGHT=320  #Uncomment this if using the new 2.4-inch waveshare display, added in San Jose
...
display = DISPLAY(display_bus, width=WIDTH, height=HEIGHT, rotation=ROTATION, auto_refresh=False)
